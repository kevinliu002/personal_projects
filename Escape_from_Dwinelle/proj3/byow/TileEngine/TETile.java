...
public class TETile {
    private final String string; // Do not rename character or the autograder will break.
     ...
     * @param string The character displayed on the screen.
     ...
     */
    public TETile(String string, Color textColor, Color backgroundColor, String description,
                  String filepath) {
        this.string = string;
    ...
    public TETile(TETile t, Color textColor) {
        this(t.string, textColor, t.backgroundColor, t.description, t.filepath);
    }
    ...
    public void draw(double x, double y) {
        ...
        StdDraw.text(x + 0.5, y + 0.5, character());
    }
